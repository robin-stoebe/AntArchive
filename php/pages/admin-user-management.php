...
<!-- 
        ...
        <!-- pages/professors.php, above your grid -->
<div class="flex justify-between items-center mb-6">
  <!-- Left: your existing filters -->
  <div class="flex items-center gap-4">
    <!-- … your Year/ Course / Search inputs … -->
  </div>

  <!-- Right: Add Professor -->
  <a href="index.php?page=add-professor"
     class="inline-flex items-center gap-2 bg-[#4b84c7] hover:bg-[#3a75ae] text-white font-medium py-2 px-4 rounded-full transition mt-6">
